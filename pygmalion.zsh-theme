...
prompt_setup_pygmalion(){
  ...
  virtualenv_format="%{$fg[blue]%} %1v -env %{$reset_color%}"
  base_prompt="%{$fg[magenta]%}%n%{$reset_color%}%{$fg[cyan]%}@%{$reset_color%}%{$fg[yellow]%}%m%{$reset_color%}%{$fg[red]%}:%{$reset_color%}%{$fg[cyan]%}%0~%{$reset_color%}%{$fg[red]%} :%{$reset_color%}$virtualenv_format"
